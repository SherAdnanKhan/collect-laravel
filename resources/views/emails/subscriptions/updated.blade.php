      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                      <div style="font-family:Source Sans Pro, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#000000;"> Hey {{ $name }},<br /> <br /> Thank you for subscribing to VEVA Collect’s {{ $planName }} Plan!<br /> <br /> We will process your payment shortly.<br /> <br /> Many thanks<br /> VEVA Collect </div>
                    </td>
                  </tr>
                </table>
              </div>
