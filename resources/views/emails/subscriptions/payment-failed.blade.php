      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                      <div style="font-family:Source Sans Pro, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#212141;"> Hey {{ $name }},<br /> <br /> It looks like we were unable to process the payment for your VEVA Collect subscription.<br /> <br /> Please <a href="{{ $accountUrl }}" style="color: #212141">click here</a> to update your payment details.<br
