...
class Credit extends Model implements UserAccessible
{
     ...
     */
    protected $fillable = [
        'party_id', 'contribution_id', 'contribution_type', 'credit_role_id', 'performing', 'instrument_id', 'split', 'credit_role_user_defined_value', 'instrument_user_defined_value', 'created_at', 'updated_at'
    ];
