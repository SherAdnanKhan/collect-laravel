      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                      <div style="font-family:Source Sans Pro, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#212141;"> Hey {{ $name }},<br /> <br /> It looks like you’ve been working hard because you’ve reached your storage limit on VEVA Collect.<br /> <br /> You can either remove some of your files (make sure you have your own backup), or upgrade
                        to one of our higher storage limit plans. Our Pro Plan includes unlimited storage amongst other great benefits!<br /> <br /> To view our other plan options <a href="" style="color: #212141">click here</a>.<br /> <br /> Many thanks<br
                        /> VEVA Collect </div>
                    </td>
                  </tr>
                </table>
