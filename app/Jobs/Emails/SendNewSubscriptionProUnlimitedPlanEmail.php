...
use App\Mail\NewSubscriptionProUnlimitedPlan;
use App\Models\User;
...
class SendNewSubscriptionProUnlimitedPlanEmail implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::to($this->user->email)->send(
            new NewSubscriptionProUnlimitedPlan($this->user, $subscriptionAmount)
        );
    }
