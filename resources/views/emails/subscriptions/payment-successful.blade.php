      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                      <div style="font-family:Source Sans Pro, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#212141;"> Hey {{ $name }},<br /> <br /> Thank you for using VEVA Collect, we appreciate your business.<br /> <br /> We have processed your payment for {{ $invoiceAmountPaid }} for the {{ $planName }} Plan.<br /> <br /> Many thanks<br /> VEVA Collect
                        </div>
                    </td>
                  </tr>
                </table>
